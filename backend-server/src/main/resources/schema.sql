...
CREATE TABLE IF NOT EXISTS `branch` (
  ...
  PRIMARY KEY (`BRCH_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='지점 정보';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='지점 소속 직원';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='회원 정보';
...
CREATE TABLE IF NOT EXISTS `member_ticket` (
  ...
  `STRT_DT` date DEFAULT NULL COMMENT '유효 시작일 (추가 권장)',
  `END_DT` date DEFAULT NULL COMMENT '유효 종료일 (추가 권장)',
  PRIMARY KEY (`TKT_ID`),
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='회원 보유 수강권';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='결제 내역';

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 demo_db.program 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `program` (
  ...
  PRIMARY KEY (`PROG_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='프로그램 정보';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='수업 예약';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='수업 시간표';

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 demo_db.staff 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `staff` (
  ...
  UNIQUE KEY `EML_ADDR` (`EML_ADDR`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='직원 정보';
...
-- 테이블 demo_db.ticket_product 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `ticket_product` (
  ...
  PRIMARY KEY (`PROD_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='수강권 상품 정보';
